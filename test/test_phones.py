...
def test_phones_on_home_page(app):
    ...
    assert contact_from_contact_page.home==clear(contact_from_edit_page.home)
    assert contact_from_contact_page.work == clear(contact_from_edit_page.work)
    assert contact_from_contact_page.mobilephone == clear(contact_from_edit_page.mobilephone)
